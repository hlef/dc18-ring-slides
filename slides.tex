...
\uncover<3->{\includegraphics[height=100px]{pix/pinguin.jpg}}
...
\begin{itemize}
\uncover<1->{\item small core team, working full time on Ring}
\uncover<2->{\item Gerrit code review}
\uncover<3->{\item previously on Tuleap, migrated to Gitlab}
\end{itemize}
